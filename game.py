...
inventory = [seed, flower, fish, ticket, tomato_seed, tomato, pumpkin_seed, pumpkin, wheat_seed, wheat]                
inventory_text = [
...
while running:
                ...
                if worker_3_seed[num] > 0 and (now_ms - last_time[0] >= 1000):
                    for cul in range(field_num[0] * field_num[1]):
                        if (worker_3_seed[num] <= 0):
                            last_time[0] = now_ms
                            break
                        if plants_seat[cul] == PLANT_NONE and (now_ms - last_time[0] >= 1000):        
    ...
    screen.blit(house, (int(background_x_pos + 865), int(background_y_pos - 1800)))     
    screen.blit(sand2, (int(background_x_pos + 1165), int(background_y_pos - 1800)))
    screen.blit(store, (int(background_x_pos + 1165), int(background_y_pos - 1800)))      
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:               
                ...
                if (store_index == 0):
                    ...
                    for cul in range(3):                       
                        if 290 < pygame.mouse.get_pos()[0] < 590:          
                        ...
                        elif 600 < pygame.mouse.get_pos()[0] < 900:           
                            if cul * 250 + 200 < pygame.mouse.get_pos()[1] < cul * 250 + 350:
                                if cul == 0:     
                                    if inventory[1] >= 1:
                                        inventory[1] -= 1
                    ...
                    if 1300 < pygame.mouse.get_pos()[0] < 1600:          
                        if 200 < pygame.mouse.get_pos()[1] < 300:              
                    ...
                    for cul in range(3):
                        if 1010 < pygame.mouse.get_pos()[0] < 1310:          
                            if cul * 250 + 200 < pygame.mouse.get_pos()[1] < cul * 250 + 350:
                                if cul == 0:
                                    if coin >= 30:
                                        inventory[8] += 1
                        ...
                        elif 1310 < pygame.mouse.get_pos()[0] < 1610:           
                            if cul * 250 + 200 < pygame.mouse.get_pos()[1] < cul * 250 + 350:
                                if cul == 0: 
                                    if inventory[8] >= 1:
                                        inventory[8] -= 1
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:               
                ...
                for cul in range(3):
                    if 290 < pygame.mouse.get_pos()[0] < 590:          
                        if cul * 250 + 200 < pygame.mouse.get_pos()[1] < cul * 250 + 350:
                            if cul == 0 and worker_3_jud == 0:     
                                if coin >= 1000:
                                    worker_3_jud = 1
                                    worker_3_seed[0] += 5
                                    coin -= 1000
                            elif cul == 1 and worker_2_jud == 0:     
                                if coin >= 5000:
                                    worker_2_jud = 1
                                    worker_2_seed[0] += 5
                                    coin -= 5000
                            elif cul == 2 and worker_1_jud == 0:     
                                if coin >= 15000:
                                    worker_1_jud = 1
                                    coin -= 15000
    ...
    if mini_game_jud == 1:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:               
                ...
                if 845 < pygame.mouse.get_pos()[0] < 1145:          
    ...
    if fountain_jud == 1 and god_message_jud == 0:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:               
                ...
                if 815 < pygame.mouse.get_pos()[0] < 1115:          
                    if 700 < pygame.mouse.get_pos()[1] < 850:
                        if inventory[9] > 99:
                                mini_game_1 = 0
                                god_message_jud = 1
    ...
    screen.blit(coin_png, (1550, 10))          
    
    screen.blit(coin_text, (1650, 20))            
    if gameover_sig == 1:           
